...
if (!auth.includes("session: { strategy: \"jwt\"")) throw new Error("JWT session invariant failed");
...
const orders = await readFile(join(root, "src/app/api/orders/route.ts"), "utf8");
