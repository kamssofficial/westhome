    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div>
            <label htmlFor="login-phone" className="text-xs font-medium text-[#6b6560] mb-1 block">Phone Number</label>
            <input id="login-phone" type="tel" name="phone" autoComplete="tel" required inputMode="tel"
