...
export default function StaffSettingsPage() {
  ...
  const inputClass = "w-full px-3 py-2.5 bg-white border border-black/[.08] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#d4a574]/30 text-[#1a1917]";

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-[#1a1917]">Settings</h1>
        <p className="text-sm text-[#6b6560] mt-1">Manage your profile and password</p>
      </div>

      <div className="bg-white rounded-2xl border border-black/[.06] p-5 space-y-4">
        <div>
          <label className="text-xs font-medium text-[#6b6560] mb-1 block">Full Name</label>
          <div className="relative">
            <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#b0aba6]" />
        ...
        <div>
          ...
          <div className="relative">
            <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#b0aba6]" />
        ...
        <div>
          <label className="text-xs font-medium text-[#6b6560] mb-1 block">Phone</label>
          <div className="relative">
            <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#b0aba6]" />
      ...
      <div className="bg-white rounded-2xl border border-black/[.06] p-5">
        <h2 className="text-sm font-semibold text-[#1a1917] mb-3 flex items-center gap-2">
